...
```
This whole training (fine-tuning) took about 3 hours on my Intel(R) Core(TM) i7-7700HQ CPU @ 2.80GHz.  Running the fine-tuning script generates an `output` directory, specified checkpoints (in the default setting, every 50 steps) saved.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjk1NTIzMTMzLC0zNzgyMTUxMTAsMTY5OD
I2NDczMSwyMDY1NDU0NTA2XX0=
-->